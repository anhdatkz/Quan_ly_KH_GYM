						...
						<div class="row">
							<div class="col-md-6 pr-md-1">
								<div class="form-group">
									<label>Họ Và Tên</label> <input type="text" class="form-control" placeholder="Họ và tên" value="" name="hovaten">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6 pr-md-1">
								<div class="form-group">
									...
									<input type="number" class="form-control" placeholder="SĐT" value="" name="sdt">
								</div>
							</div>
							<div class="col-md-6 pl-md-1">
